...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // button listens for when it is clicked
            @Override
    ...
    public void sendMessage(){
        ...
        if (!(message.equals(""))) {
            Conversation conversation = new Conversation(message,uId);
            mFireBaseMessages.push().setValue(conversation);
            editText.setText("");
        }
    }
